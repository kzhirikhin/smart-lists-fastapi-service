...
32 ревизии эпохи Anthropic удалены. Живут две ревизии — `insights-api-00059-fhh`
под трафиком и `insights-api-00058-kdq` как точка отката; обе на Vertex AI.
Число ревизий ничем не ограничено автоматически: уборка ручная.
